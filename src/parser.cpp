...
#undef YYCASE_
  ...
  parser::yypact_[] =
  {
       1,    -8,   -11,   -11,    -3,   -12,     7,   -12,     8,   -12,
     -12,    32,   -12,    18,     5,   -12,    -8,    -8,   -12,     1,
      -8,    -8,    -8,    -8,   -12,    11,    32,    25,    24,   -12,
     -12,    -5,    -5,   -12,   -12,    11,    31,    -8,   -12,   -12,
     -12,   -12
  };
  ...
  parser::yytable_[] =
  {
      13,     1,    22,    23,    -5,    14,    17,    18,     4,     5,
       1,    19,     2,     3,    25,    26,    27,     4,     5,    31,
      32,    33,    34,    20,    21,    22,    23,    35,    24,    37,
      20,    21,    22,    23,    38,    30,    27,    20,    21,    22,
      23,    40,    16,    41,    39
  };
  ...
  parser::yycheck_[] =
  {
       1,     9,     7,     8,     3,    16,     9,     0,    16,    17,
       9,     3,    11,    12,     9,    16,    17,    16,    17,    20,
      21,    22,    23,     5,     6,     7,     8,    16,    10,     4,
       5,     6,     7,     8,    10,    19,    37,     5,     6,     7,
       8,    10,     3,    37,    35
  };
  ...
  parser::yystos_[] =
  {
       0,     9,    11,    12,    16,    17,    19,    20,    21,    22,
      23,    26,    27,    26,    16,    24,    24,     9,     0,     3,
       5,     6,     7,     8,    10,     9,    26,    26,    28,    29,
      20,    26,    26,    26,    26,    16,    25,     4,    10,    25,
      10,    29
  };
  ...
  "\"-\"", "\"+\"", "\"*\"", "\"/\"", "\"(\"", "\")\"", "\"extern\"",
  "\"fun\"", "\"if\"", "\"while\"", "\"for\"", "\"id\"", "\"number\"",
  "$accept", "startsymb", "program", "top", "definition", "external",
  "proto", "idseq", "exp", "idexp", "optexp", "explist", YY_NULLPTR
  };
#endif
  ...
  parser::yyrline_[] =
  {
      ...
      84,    87,    90,    92,    99,   100,   101,   102,   103,   104,
     105,   108,   109,   112,   116,   119,   123
  };
